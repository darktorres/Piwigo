...
) + 24 * 3600)) {// somehow arbitrary - if derivative params or src didn't change for the last 24 hours, we send an expire header for several days
...
if ($logger->severity() >= Logger::DEBUG) {
    $logger->debug('', 'i.php', [
        ...
        'mem_usage' => function_exists('memory_get_peak_usage') ? round(
