...
file_exists(PHPWG_ROOT_PATH . PWG_LOCAL_DIR . 'config/database.inc.php') && require PHPWG_ROOT_PATH . PWG_LOCAL_DIR . 'config/database.inc.php';
...
} elseif ($now > (max($src_mtime, $params->last_mod_time) + 24 * 3600)) {// somewhat arbitrary - if derivative params or src haven't changed for the last 24 hours, we send an expire header for several days
