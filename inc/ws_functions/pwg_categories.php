...
class pwg_categories
{
  ...
  ;';
        ...
        if (! empty($params['status'])) {
            ...
            if ($params['status'] != $category['status']) {
                include_once(PHPWG_ROOT_PATH . 'admin/inc/functions.php');
                functions::set_cat_status([$params['category_id']], $params['status']);
            }
        }
        ...
        if (! empty($params['visible']) and ($params['visible'] != $category['visible'])) {
            include_once(PHPWG_ROOT_PATH . 'admin/inc/functions.php');
            functions::set_cat_visible([$params['category_id']], $params['visible']);
        }
  ...
  ;';
        ...
        functions::set_random_representant([$params['category_id']]);
