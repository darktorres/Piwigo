...
class pwg
{
  ...
  ;';
    ...
    public static function ws_history_log($params, &$service)
    {
        ...
        if (! empty($params['section']) and in_array($params['section'], functions_mysqli::get_enums('history', 'section'))) {
  ...
  ;';
        ...
        usort($data, '\Piwigo\admin\inc\functions_history::history_compare');
