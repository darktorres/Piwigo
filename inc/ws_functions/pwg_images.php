...
class pwg_images
{
  ...
  ;';
     ...
     * } $params
     * @param $service
     * @return PwgError|PwgNamedStruct[]
     * @throws Exception
  ...
  ;';
        ...
        if (isset($params['tags']) and ! empty($params['tags'])) {
            ...
            functions::add_tags($tag_ids, [$image_id]);
        }
  ...
  ;';
        ...
        if ($params['action'] == 'associate') {
            functions::associate_images_to_categories($params['image_id'], [$params['category_id']]);
            ...
            functions::move_images_to_categories($params['image_id'], [$params['category_id']]);
        }
