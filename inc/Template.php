...
class Template
{
    ...
    public function __construct($root = '.', $theme = '', $path = 'template')
    {
        ...
        $this->smarty->registerPlugin('modifiercompiler', 'translate', ['Piwigo\inc\Template', 'modcompiler_translate']);
        $this->smarty->registerPlugin('modifiercompiler', 'translate_dec', ['Piwigo\inc\Template', 'modcompiler_translate_dec']);
        ...
        $this->smarty->registerPlugin('modifier', 'explode', ['Piwigo\inc\Template', 'mod_explode']);
        $this->smarty->registerPlugin('modifier', 'ternary', ['Piwigo\inc\Template', 'mod_ternary']);
        ...
        $this->smarty->registerFilter('pre', ['Piwigo\inc\Template', 'prefilter_white_space']);
        if ($conf['compiled_template_cache_language']) {
            $this->smarty->registerFilter('post', ['Piwigo\inc\Template', 'postfilter_language']);
        }
        ...
        if (! empty($theme)) {
            ...
            if (! defined('IN_ADMIN')) {
                $this->set_prefilter('header', ['Piwigo\inc\Template', 'prefilter_local_css']);
            }
        } else {
