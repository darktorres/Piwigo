...
$core = [
    ...
    [
        ...
        'files' => ['inc\functions_category.inc.php (get_categories_menu)'],
    ],
    [
        'name' => 'get_category_preferred_image_orders',
        'type' => 'trigger_change',
        'vars' => ['array', null],
        'files' => ['inc\functions_category.inc.php (get_category_preferred_image_orders)'],
    ],
    [
    ...
    [
        ...
        'files' => ['inc\functions_user.inc.php (try_log_user)'],
    ],
    [
        'name' => 'login_success',
        'type' => 'trigger_notify',
        'vars' => ['string', 'username'],
        'files' => ['inc\functions_user.inc.php (auto_login, try_log_user)'],
    ],
    [
    ...
    [
        ...
        'type' => 'trigger_notify',
        'vars' => [],
        'files' => ['inc\functions_plugins.inc.php (load_plugins)'],
    ],
    [
    ...
    [
        ...
        'type' => 'trigger_notify',
        'vars' => ['array', 'user'],
        'files' => ['inc\functions_user.inc.php (register_user)'],
    ],
    [
    ...
    [
        ...
        'type' => 'trigger_notify',
        'vars' => ['array', null],
        'files' => ['inc\functions_plugins.inc.php (trigger_change, trigger_notify)'],
    ],
    [
    ...
    [
        ...
        'type' => 'trigger_notify',
        'vars' => ['int', 'user_id'],
        'files' => ['inc\functions_user.inc.php (logout_user)'],
        'infos' => 'New in 2.5',
    ],
    [
        'name' => 'user_login',
        'type' => 'trigger_notify',
        'vars' => ['int', 'user_id'],
        'files' => ['inc\functions_user.inc.php (log_user)'],
        'infos' => 'New in 2.5',
    ],
    [
        'name' => 'try_log_user',
