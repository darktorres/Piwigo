...
$core = [
    [
        ...
        'type' => 'FunctionsPlugins::trigger_change',
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['array', 'ids'],
        'files' => ['admin\inc\functions.inc.php (delete_elements)'],
    ],
    [
        'name' => 'blockmanager_apply',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['object', 'menublock'],
        'files' => ['inc\block.class.php (BlockManager::apply)'],
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['object', 'this'],
        'files' => ['inc\block.class.php (BlockManager::prepare_display)'],
    ],
    [
        'name' => 'blockmanager_register_blocks',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['object', 'menu'],
        'files' => ['inc\block.class.php (BlockManager::load_registered_blocks)'],
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'value'],
        'files' => ['inc\functions_metadata.inc.php (clean_iptc_value)'],
    ],
    [
        'name' => 'combined_css',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'href', 'Combinable', '$combinable'],
        'files' => ['inc\template.class.php (Template::flush)'],
    ],
    [
        'name' => 'combined_css_postfilter',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'css'],
        'files' => ['inc\template.class.php (Template::process_css)'],
    ],
    [
        'name' => 'combined_script',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'ret', 'string', 'script'],
        'files' => ['inc\template.class.php (Template::make_script_src)'],
    ],
    [
        'name' => 'delete_categories',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['array', 'ids'],
        'files' => ['admin\inc\functions.inc.php (delete_categories)'],
    ],
    [
        'name' => 'delete_group',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['array', 'groupids'],
        'files' => ['admin\group_list.php', 'admin\inc\functions.inc.php (delete_group)'],
    ],
    [
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['array', 'tag_ids'],
        'files' => ['admin\inc\functions.inc.php (delete_tags)'],
    ],
    [
        'name' => 'delete_user',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['int', 'user_id'],
        'files' => ['admin\inc\functions.inc.php (delete_user)'],
    ],
    [
    ...
    [
        ...
        'files' => ['inc\functions_metadata.inc.php (get_exif_data)'],
    ],
    [
        'name' => 'functions_history_included',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => [],
        'files' => ['admin\inc\functions_history.inc.php'],
    ],
    [
        'name' => 'functions_mail_included',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => [],
        'files' => ['inc\functions_mail.inc.php'],
    ],
    [
    ...
    [
        ...
        'files' => ['inc\FunctionsCategory.php (get_categories_menu)'],
    ],
    [
        'name' => 'get_category_preferred_image_orders',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['array', null],
        'files' => ['inc\FunctionsCategory.php (get_category_preferred_image_orders)'],
    ],
    [
        'name' => 'get_download_url',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'url', 'array', 'element_info'],
        'files' => ['inc\functions_picture.inc.php (get_download_url)'],
    ],
    [
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'url', 'array', 'element_info'],
        'files' => ['inc\functions_picture.inc.php (get_element_url)'],
    ],
    [
        'name' => 'get_high_location',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'location', 'array', 'element_info'],
        'files' => ['inc\functions_picture.inc.php (get_high_location)'],
    ],
    [
        'name' => 'get_high_url',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'url', 'array', 'element_info'],
        'files' => ['inc\functions_picture.inc.php (get_high_url)'],
    ],
    [
        'name' => 'get_history',
        'type' => 'FunctionsPlugins::trigger_change',
    ...
    [
        ...
        'files' => ['inc\functions_picture.inc.php (get_image_location)'],
    ],
    [
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['array', 'themes'],
        'files' => ['inc\functions.inc.php (get_pwg_themes)'],
    ],
    [
        'name' => 'get_thumbnail_title',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'title', 'array', 'info'],
        'files' => ['inc\functions.inc.php (get_thumbnail_title)'],
    ],
    [
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['ImageStdParams', null],
        'files' => ['includecategory_cats.php', 'inc\category_default.inc.php'],
        'infos' => 'New in 2.4',
    ],
    [
        ...
        'files' => ['inc\derivative.inc.php (SrcImage::__construct)'],
        'infos' => 'New in 2.4',
    ],
    [
        ...
        'files' => ['inc\derivative.inc.php (SrcImage::url, SrcImage::get_url)'],
        'infos' => 'New in 2.4',
    ],
    [
        ...
        'files' => ['admin\tags.php', 'admin\inc\functions.php (get_taglist)'],
        'infos' => 'New in 2.4',
    ],
    [
        ...
        'files' => ['admin\inc\functions.php (tag_id_from_tag_name)'],
        'infos' => 'New in 2.7',
    ],
    [
        ...
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'email'],
        'files' => ['inc\functions.inc.php (get_webmaster_mail_address)'],
        'infos' => 'New in 2.6',
    ],
    [
        'name' => 'init',
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['bool', 'full'],
        'files' => ['admin\inc\functions.inc.php (invalidate_user_cache)'],
    ],
    [
        'name' => 'load_conf',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['string', 'condition'],
        'files' => ['inc\functions.inc.php (load_conf_from_db)'],
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['object', 'this'],
        'files' => ['admin\inc\check_integrity.class.php (check_integrity::check)'],
    ],
    [
        'name' => 'load_image_library',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['object', 'this'],
        'files' => ['admin\inc\image.class.php (pwg_image::__construct)'],
    ],
    [
    ...
    [
        ...
        'files' => [
            'inc\common.inc.php',
            'inc\functions.inc.php (redirect_html)',
            'inc\functions_mail.inc.php (switch_lang_to)',
            'nbm.php',
        ],
    ],
    [
    ...
    [
        ...
        'files' => ['inc\category_cats.inc.php'],
    ],
    [
        'name' => 'loc_begin_index_thumbnails',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['array', 'pictures'],
        'files' => ['inc\category_default.inc.php'],
    ],
    [
    ...
    [
        ...
        'files' => ['admin\inc\functions_upload.inc.php (add_uploaded_file)'],
        'infos' => 'New in 2.11',
    ],
    [
        'name' => 'empty_lounge',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['array', 'rows'],
        'files' => ['admin\inc\functions.php (empty_lounge)'],
        'infos' => 'New in 12',
    ],
    [
        ...
        'files' => ['inc\ws_functions\pwg.images.php (ws_images_uploadCompleted)'],
        'infos' => 'New in 12',
    ],
    [
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => [],
        'files' => ['inc\section_init.inc.php'],
    ...
    [
        ...
        'files' => ['inc\FunctionsUser.php (try_log_user)'],
    ],
    [
        'name' => 'login_success',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['string', 'username'],
        'files' => ['inc\FunctionsUser.php (auto_login, try_log_user)'],
    ],
    [
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => [],
        'files' => ['inc\functions_plugins.inc.php (FunctionsPlugins::load_plugins)'],
    ],
    [
        'name' => 'pwg_log_allowed',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['bool', 'do_log', 'int', 'image_id', 'string', 'image_type'],
        'files' => ['inc\functions.inc.php (pwg_log)'],
    ],
    [
        'name' => 'register_user',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['array', 'user'],
        'files' => ['inc\FunctionsUser.php (register_user)'],
    ],
    [
    ...
    [
        ...
        'files' => [
            'inc\category_cats.inc.php',
            'inc\section_init.inc.php',
            'inc\ws_functions.inc.php (ws_categories_getList, ws_categories_getAdminList)',
        ],
    ],
    [
    ...
    [
        ...
        'files' => [
            'admin\cat_list.php',
            'inc\ws_functions.inc.php (ws_categories_getList, ws_categories_getAdminList, ws_categories_move)',
        ],
    ],
    [
        ...
        'files' => ['admin\comments.php', 'comments.php', 'inc\picture_comment.inc.php'],
    ],
    [
    ...
    [
        ...
        'files' => ['inc\functions_html.inc.php (render_element_name)'],
    ],
    [
        'name' => 'render_element_description',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['string', 'element_description', 'string', 'action'],
        'files' => ['picture.php', 'inc\functions_html.inc.php (render_element_description)'],
    ],
    [
    ...
    [
        ...
        'files' => [
            'admin\inc\functions.php (get_taglist)',
            'admin\tags.php',
            'admin\history.php',
            'inc\functions_tag.inc.php (get_available_tags, get_all_tags, get_common_tags)',
            'inc\functions_html.inc.php (get_tags_content_title)',
            'inc\functions_search.inc.php (get_qsearch_tags)',
        ],
    ],
    [
        'name' => 'render_tag_url',
        ...
        'files' => ['admin\inc\functions.php (tag_id_from_tag_name, create_tag)', 'admin\tags.php'],
    ],
    [
    ...
    [
        ...
        'files' => ['inc\functions_mail.inc.php (pwg_mail)'],
    ],
    [
    ...
    [
        ...
        'files' => ['inc\functions_html.inc.php (set_status_header)'],
    ],
    [
        'name' => 'tabsheet_before_select',
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['array', 'sheets', 'string', 'tabsheet_id'],
        'files' => ['inc\tabsheet.class.php (tabsheet::select)'],
    ...
    [
        ...
        'vars' => ['array', null],
        'files' => [
            'inc\functions_plugins.inc.php (FunctionsPlugins::trigger_change, FunctionsPlugins::trigger_notify)',
        ],
    ],
    [
        ...
        'files' => ['inc\functions_comment.inc.php (insert_user_comment, update_user_comment)'],
    ...
    [
        ...
        'files' => ['inc\functions_comment.inc.php (delete_user_comment)'],
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['array', 'comm'],
        'files' => ['inc\picture_comment.inc.php'],
    ],
    [
        'name' => 'user_comment_validation',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['mixed', 'comment_id'],
        'files' => ['inc\functions_comment.inc.php (validate_user_comment)'],
        'infos' => '$comment_id is and int or an array of int',
    ],
    [
        'name' => 'user_init',
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['int', 'user_id'],
        'files' => ['inc\FunctionsUser.php (logout_user)'],
        'infos' => 'New in 2.5',
    ],
    [
        'name' => 'user_login',
        'type' => 'FunctionsPlugins::trigger_notify',
        'vars' => ['int', 'user_id'],
        'files' => ['inc\FunctionsUser.php (log_user)'],
        'infos' => 'New in 2.5',
    ],
    [
        'name' => 'try_log_user',
    ...
    [
        ...
        'files' => ['inc\template.class.php (FileCombiner::process_combinable)'],
        'infos' => 'New in 2.6.',
    ],
    [
        ...
        'files' => ['inc\functions_rate.inc.php'],
        'infos' => 'New in 2.6.',
    ],
    [
    ...
    [
        ...
        'type' => 'FunctionsPlugins::trigger_change',
        'vars' => ['array', 'users'],
        'files' => ['inc\ws_functions\pwg.users.php'],
        'infos' => 'New in 2.6.2.',
    ],
];
?>
    ...
    <tr>
      ...
      <td>
        <select class="search_input">
          ...
          <option value="FunctionsPlugins::trigger_notify">FunctionsPlugins::trigger_notify</option>
          <option value="FunctionsPlugins::trigger_change">FunctionsPlugins::trigger_change</option>
        </select>
      </td>
