...
// import "../../../node_modules/mousetrap/mousetrap.js"
// import "../../../node_modules/jquery-colorbox/jquery.colorbox-min.js"
// import "https://raw.githack.com/Piwigo/Piwigo/refs/heads/14.x/themes/default/js/plugins/jquery.tokeninput.js";
...
var ato_height = 28; // normal height, real height conputed on init()
...
function initRepresentative(image_id, category_id) {
  $ato.find(".set-representative").on("click", function (e) {
    if (!$(this).parent().hasClass("disabled")) {
      ...
      $.ajax({
        method: "POST",
        url: urlWS + "pwg.categories.setRepresentative",
        dataType: "json",
        data: {
          image_id: image_id,
...
function initQuickEdit(is_picture, tokeninput_lang) {
  ...
  window.Mousetrap.bind("mod+e", function (e) {
    e.preventDefault();
    $(".edit-quick").click();
  });
}
