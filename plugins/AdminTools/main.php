...
functions_plugins::add_event_handler('ws_add_methods', ['Piwigo\plugins\AdminTools\inc\MultiView', 'register_ws']);
functions_plugins::add_event_handler('delete_user', ['Piwigo\plugins\AdminTools\inc\MultiView', 'invalidate_cache']);
functions_plugins::add_event_handler('register_user', ['Piwigo\plugins\AdminTools\inc\MultiView', 'invalidate_cache']);
