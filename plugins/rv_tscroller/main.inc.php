    ...
    public static function on_index_begin()
    {
        ...
        if (! $is_ajax) {
            if (empty($page['items'])) {
                ...
                add_event_handler('loc_end_index_thumbnails', ['RVTS', 'on_index_thumbnails']);
            }
        } else {
            ...
            add_event_handler('loc_end_index_thumbnails', ['RVTS', 'on_index_thumbnails_ajax'], EVENT_HANDLER_PRIORITY_NEUTRAL + 5);
