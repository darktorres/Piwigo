                      ...
                      for (u = 0; u < p.length; u++)
                        (d = l[++s]),
                          ...
                          typeof c === o && c.length > 0
                            ? 2 == c.length
                              ? (t[c[0]] = typeof c[1] == i ? c[1].call(this, d) : c[1])
                              : 3 == c.length
                              ? (t[c[0]] = typeof c[1] !== i || (c[1].exec && c[1].test) ? (d ? d.replace(c[1], c[2]) : e) : d ? c[1].call(this, d, c[2]) : e)
        ...
        (n = n || {}),
          ...
          e.extend(this, {
            ...
            getShimContainer: function () {
              ...
              return (
                i ||
                  ((n = this.options.container ? t.get(this.options.container) : document.body),
              ...
              return t.length
                ? ((s = t.shift()),
                  (u = n.getConstructor(s))
                    ...
                    : void o(t))
                : (a.trigger("RuntimeError", new e.RuntimeError(e.RuntimeError.NOT_INIT_ERR)), void (i = null));
            }
            var a = this,
              s;
    ...
    i(w, [u, l, y], function (e, t, n) {
      function i(i, r) {
        ...
        n.apply(this, arguments),
          e.extend(this, { type: a || "", name: o || e.guid("file_"), lastModifiedDate: r.lastModifiedDate || new Date().toLocaleString() });
      }
                    ...
                    c.bind("Refresh", function () {
                      ...
                      (a = n.get(r.browse_button)),
                        ...
                        a &&
                          ...
                          (o = n.getSize(a)),
                          s && e.extend(s.style, { top: t.y + "px", left: t.x + "px", width: o.w + "px", height: o.h + "px" })),
                        (s = a = null);
                    }),
    ...
    i(_, [c, f, h, u, w, v, p, l], function (e, t, n, i, r, o, a, s) {
      function u(n) {
        ...
        "string" == typeof n && (n = { drop_zone: n }),
          (u = { accept: [{ title: e.translate("All Files"), extensions: "*" }], required_caps: { drag_and_drop: !0 } }),
      ...
      function h() {
        ...
        function u(t) {
          ...
          (M = new Date().getTime()),
            ...
            (P.required_caps = e.extend({}, P.required_caps, { return_response_type: s.responseType })),
        ...
        e.extend(this, y, {
          ...
          open: function (o, a, s, u, c) {
            ...
            if (
              (~e.inArray(o.toUpperCase(), ["CONNECT", "DELETE", "GET", "HEAD", "OPTIONS", "POST", "PUT", "TRACE", "TRACK"]) && (_ = o.toUpperCase()),
          ...
          overrideMimeType: function (i) {
            ...
            if (
              ((i = e.trim(i.toLowerCase())), /;/.test(i) && (r = i.match(/^([^;]+)(?:;\scharset\=)?(.*)$/)) && ((i = r[1]), r[2] && (o = r[2])), !d.mimes[i])
            )
          ...
          (r.name = t.name || ""),
            t.isDetached()
              ? (this.bind("RuntimeInit", function (e, t) {
                ...
                this.connectRuntime(e.extend({ required_caps: { access_image_binary: !0, resize_image: !0 } }, n)))
          ...
          e.extend(this, {
            ...
            downsize: function (t) {
              ...
              t =
                "object" == typeof t
                  ? e.extend(i, t)
                  : e.extend(i, { width: arguments[0], height: arguments[1], crop: arguments[2], preserveHeaders: arguments[3] });
              try {
          ...
          if (((n = n.toLowerCase()), t[r] && i[t[r]] && i[t[r]][n])) {
            ...
            for (
              ...
              ((a[u].orig !== o && a[u].key !== o) ||
                (t.removeEventListener ? t.removeEventListener(n, a[u].func, !1) : t.detachEvent && t.detachEvent("on" + n, a[u].func),
                (a[u].orig = null),
                (a[u].func = null),
                a.splice(u, 1),
                o === s));
          ...
          init: function (s) {
            ...
            (a = s),
              ...
              (d.innerHTML =
                ...
                (a.directory && c.can("select_folder") ? "webkitdirectory directory" : "") +
                (f ? ' accept="' + f.join(",") + '"' : "") +
                " />"),
              (l = n.get(c.uid)),
              t.extend(l.style, { position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }),
              ...
              i.addEvent(
                ...
                function (n) {
                  e(n) &&
                    (n.preventDefault(),
                    (d = []),
                    n.dataTransfer.items && n.dataTransfer.items[0].webkitGetAsEntry
    ...
    i(H, [D, u, l, R, w, y, A, h, d], function (e, t, n, i, r, o, a, s, u) {
      function c() {
        ...
        function l(e) {
          ...
          return (
            "IE" === u.browser &&
              ...
              ((t = new window.ActiveXObject("Microsoft.XMLDOM")), (t.async = !1), (t.validateOnParse = !1), t.loadXML(n)),
        ...
        function d(e) {
          ...
          return (
            h.setRequestHeader("Content-Type", "multipart/form-data; boundary=" + t),
            e.each(function (e, a) {
              r +=
                e instanceof o
                  ? n +
                    ...
                    e.getSource() +
                    i
                  : n + t + i + 'Content-Disposition: form-data; name="' + a + '"' + i + i + unescape(encodeURIComponent(e)) + i;
            }),
            (r += n + t + n + i)
          );
        }
        ...
        t.extend(this, {
          send: function (n, r) {
            var s = this,
              ...
              m = !1;
            if (
              ((p = n.url.replace(/^.+?\/([\w\-\.]+)$/, "$1").toLowerCase()), (h = c()), h.open(n.method, n.url, n.async, n.user, n.password), r instanceof o)
            )
            ...
            h.upload
              ...
              "" !== n.responseType &&
                "responseType" in h &&
                (h.responseType = "json" !== n.responseType || u.can("return_response_type", "json") ? n.responseType : "text"),
              m
                ? h.sendAsBinary
                  ? h.sendAsBinary(r)
                  : !(function () {
        ...
        if (((r = new e()), r.init(n), 65496 === r.SHORT(0))) {
          for (o = 2; o <= n.length; )
            if (((a = r.SHORT(o)), a >= 65488 && 65495 >= a)) o += 2;
              ...
              (s = r.SHORT(o + 2) + 2),
                a >= 65505 && 65519 >= a && i.push({ hex: a, name: "APP" + (15 & a), start: o, length: s, segment: r.SEGMENT(o, s) }),
                (o += s);
            }
          return (
            r.init(null),
            {
              ...
              set: function (e, t) {
                var n = [],
                  ...
                  a;
                for (
                  "string" == typeof t ? n.push(t) : (n = t), r = o = 0, a = i.length;
                  a > r && (i[r].name === e.toUpperCase() && ((i[r].segment = n[o]), (i[r].length = n[o].length), o++), !(o >= n.length));
                  r++
                );
              },
              purge: function () {
      ...
      return function i() {
          ...
          return (
            ...
            42 !== a.SHORT((e += 2))
              ...
              : ((c.IFD0 = c.tiffHeader + a.LONG((e += 2))),
                (u = i(c.IFD0, s.tiff)),
                "ExifIFDPointer" in u && ((c.exifIFD = c.tiffHeader + u.ExifIFDPointer), delete u.ExifIFDPointer),
                "GPSInfoIFDPointer" in u && ((c.gpsIFD = c.tiffHeader + u.GPSInfoIFDPointer), delete u.GPSInfoIFDPointer),
                !0)
          );
        }
        function o(e, t, n) {
        ...
        return (
          ...
          }),
          {
            init: function (e) {
              return (
                (c = { tiffHeader: 10 }), e !== t && e.length ? (a.init(e), 65505 === a.SHORT(0) && "EXIF\x00" === a.STRING(4, 5).toUpperCase() ? r() : !1) : !1
              );
            },
            TIFF: function () {
              return u;
        ...
        t.extend(this, {
          ...
          getAsBlob: function (e, t) {
            return (
              ...
              new r(null, { name: x.name || "", type: e, data: v.getAsBinaryString.call(this, e, t) })
            );
          },
          ...
          getAsBinaryString: function (e, t) {
            ...
            if ("image/jpeg" !== e) _ = c(v.getAsDataURL(e, t));
              ...
              (_ = c(n)),
                w &&
                  ((_ = w.stripHeaders(_)),
                  R && (w.meta && w.meta.exif && w.setExif({ PixelXDimension: this.width, PixelYDimension: this.height }), (_ = w.writeHeaders(_))),
                  w.purge(),
                  (w = null));
            }
            return (b = !1), _;
        ...
        r = {
          read: function (e, t) {
            var r = this,
              o = r.getRuntime();
            return (
              "readAsDataURL" === e && (i = "data:" + (t.type || "") + ";base64,"),
              ...
              t.each(n, function (e) {
                ...
                if (t && t.keys)
                  for (i.meta[e] = {}, o = 0, a = t.keys.length; a > o; o++)
                    (n = t.keys[o]),
                      (s = t[n]),
                      s && (/^(\d|[1-9]\d+)$/.test(s) ? (s = parseInt(s, 10)) : /^\d*\.\d+$/.test(s) && (s = parseFloat(s)), (i.meta[e][n] = s));
              }),
      ...
      function a() {
        function e() {
          ...
          (g = t.guid("uid_")),
            ...
            a && ((h = n.get(a + "_form")), h && t.extend(h.style, { top: "100%" })),
            ...
            t.extend(p.style, { overflow: "hidden", position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }),
            ...
            p.appendChild(m),
            d.appendChild(p),
            t.extend(m.style, { position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }),
            "IE" === o.browser && o.version < 10 && t.extend(m.style, { filter: "progid:DXImageTransform.Microsoft.Alpha(opacity=0)" }),
            (m.onchange = function () {
              var t;
              this.value &&
                  ...
                  function i() {
                    ...
                    r.unbind("change", i),
                      r.files.length &&
                        e &&
                        t &&
                        ((o = r.files[0]), e.setAttribute("id", o.uid), t.setAttribute("id", o.uid + "_form"), t.setAttribute("target", o.uid + "_iframe")),
                      (e = t = null);
                  },
                  998
                ),
                      ...
                      (n = l.contentWindow.document || l.contentDocument || window.frames[l.id].document),
                        /^4(0[0-9]|1[0-7]|2[2346])\s/.test(n.title)
                          ...
                          : ((u = 200),
                            ...
                            p.trigger({ type: "progress", loaded: c.length, total: c.length }),
...
(function (e, t, n) {
  ...
  o.addFileFilter("mime_types", function (e, t, n) {
    e.length && !e.regexp.test(t.name)
      ? (this.trigger("Error", { code: o.FILE_EXTENSION_ERROR, message: o.translate("File extension error."), file: t }), n(!1))
      : n(!0);
  }),
    o.addFileFilter("max_file_size", function (e, t, n) {
      ...
      (e = o.parseSize(e)),
        t.size !== r && e && t.size > e
          ? (this.trigger("Error", { code: o.FILE_SIZE_ERROR, message: o.translate("File size error."), file: t }), n(!1))
          : n(!0);
    }),
    ...
    (o.Uploader = function (e) {
      ...
      function b() {
        ...
        d.size === n
          ...
          : ((d.bytesPerSec = Math.ceil(d.loaded / ((+new Date() - p || 1) / 1e3))), (d.percent = d.size > 0 ? Math.ceil((d.loaded / d.size) * 100) : 0));
      }
      function w() {
        var e = c[0] || h[0];
            ...
            o.each(e.browse_button, function (n) {
              s.push(function (s) {
                ...
                (a.onready = function () {
                  ...
                  t.extend(r.features, { chunks: e.can("slice_blob"), multipart: e.can("send_multipart"), multi_selection: e.can("select_multiple") }),
                    i++,
                    c.push(this),
                    s();
                }),
                  ...
                  a.bind("mouseenter mouseleave mousedown mouseup", function (r) {
                    v ||
                      (e.browse_button_hover &&
                        ("mouseenter" === r.type ? t.addClass(n, e.browse_button_hover) : "mouseleave" === r.type && t.removeClass(n, e.browse_button_hover)),
                      e.browse_button_active &&
                        ("mousedown" === r.type ? t.addClass(n, e.browse_button_active) : "mouseup" === r.type && t.removeClass(n, e.browse_button_active)));
                  }),
          ...
          r
            ...
            : u &&
              ...
              x.call(i, a, function (e) {
                e
                  ? ((i.runtime = t.Runtime.getInfo(w()).type), i.trigger("Init", { runtime: i.runtime }), i.trigger("PostInit"))
      ...
      function k(e, n) {
        ...
        function p() {
          ...
          e.settings.send_file_name && (g.name = n.target_name || n.name),
            ...
            s &&
              a.chunks &&
              (e.settings.send_chunk_number ? ((g.chunk = Math.ceil(f / s)), (g.chunks = Math.ceil(c.size / s))) : ((g.offset = f), (g.total = c.size))),
              ...
              (u = e.settings.max_retries),
                ...
                !f || f >= c.size
                  ? (n.size != n.origSize && (c.destroy(), (c = null)),
                    ...
                    (n.status = o.DONE),
                    e.trigger("FileUploaded", n, { response: m.responseText, status: m.status, responseHeaders: m.getAllResponseHeaders() }))
                  : r(p, 1);
            }),
            (m.onerror = function () {
              h();
