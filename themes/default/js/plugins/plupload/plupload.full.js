  ...
  !(function (e, t) {
    ...
    n("moxie/core/utils/Basic", [], function () {
                          ...
                          (l = c[++a]),
                            ...
                            typeof u === o && u.length > 0
                              ? 2 == u.length
                                ...
                                : 3 == u.length
                                ? (t[u[0]] = typeof u[1] !== n || (u[1].exec && u[1].test) ? (l ? l.replace(u[1], u[2]) : e) : l ? u[1].call(this, l, u[2]) : e)
                                : 4 == u.length && (t[u[0]] = l ? u[3].call(this, l.replace(u[1], u[2])) : e)
                              : (t[u] = l ? l : e);
                        break;
                      }
                    if (c) break;
              ...
              getShimContainer: function () {
                ...
                return (
                  n ||
                    ...
                    t.extend(n.style, { position: "absolute", top: "0px", left: "0px", width: "1px", height: "1px", overflow: "hidden" }),
                    e.appendChild(n),
                    (e = null)),
                  n
                );
      ...
      n(
        ...
        ["moxie/core/utils/Env", "moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/runtime/Runtime"],
        function (e, t, i, n) {
          return function () {
            var e;
            i.extend(this, {
                  ...
                  return i.length
                    ? ((a = i.shift().toLowerCase()),
                      (u = n.getConstructor(a))
                        ...
                        : (o(i), void 0))
                    : (s.trigger("RuntimeError", new t.RuntimeError(t.RuntimeError.NOT_INIT_ERR)), (e = null), void 0);
                }
                var a,
                  s = this;
      ...
      n(
        ...
        function (e, t, i, n, r, o, a, s, u) {
          function c(t) {
            var o, c, d;
            if ((-1 !== e.inArray(e.typeOf(t), ["string", "node"]) && (t = { browse_button: t }), (c = n.get(t.browse_button)), !c))
              throw new r.DOMException(r.DOMException.NOT_FOUND_ERR);
            (d = { accept: [{ title: a.translate("All Files"), extensions: "*" }], multiple: !1, required_caps: !1, container: c.parentNode || document.body }),
              (t = e.extend({}, d, t)),
                      ...
                      i.bind("Refresh", function () {
                        ...
                        (a = n.get(t.browse_button)),
                          ...
                          a &&
                            ...
                            s && e.extend(s.style, { top: i.y + "px", left: i.x + "px", width: r.w + "px", height: r.h + "px", zIndex: u + 1 })),
                          (s = a = null);
                      }),
        ...
        function (e, t, i, n, r, o, a, s, u) {
          function c(i) {
            ...
            "string" == typeof i && (i = { drop_zone: i }),
              (r = { accept: [{ title: e.translate("All Files"), extensions: "*" }], required_caps: { drag_and_drop: !0 } }),
          ...
          function a() {
            function n(e, n) {
              if ((this.trigger("loadstart"), this.readyState === a.LOADING))
                return this.trigger("error", new i.DOMException(i.DOMException.INVALID_STATE_ERR)), this.trigger("loadend"), void 0;
          ...
          function h() {
            ...
            function u(t) {
                ...
                _.bind("LoadStart", function (e) {
                  ...
                  _.bind("Load", function (t) {
                    i("readyState", h.DONE),
                      ...
                      i("status") > 0 ? (L && s.upload.dispatchEvent(t), s.dispatchEvent(t)) : ((F = !0), s.dispatchEvent("error")),
                      n();
                  }),
              ...
              (E = new Date().getTime()),
                ...
                (k.required_caps = e.extend({}, k.required_caps, { return_response_type: s.responseType })),
            ...
            e.extend(this, I, {
              ...
              open: function (o, a, s, u, c) {
                ...
                if (
                  (~e.inArray(o.toUpperCase(), ["CONNECT", "DELETE", "GET", "HEAD", "OPTIONS", "POST", "PUT", "TRACE", "TRACK"]) && (v = o.toUpperCase()),
                ...
                if (((w = u || l.user), (y = c || l.pass), (T = s || !0), T === !1 && (i("timeout") || i("withCredentials") || "" !== i("responseType"))))
                  throw new t.DOMException(t.DOMException.INVALID_ACCESS_ERR);
              ...
              send: function (i, r) {
                if (((k = "string" === e.typeOf(r) ? { ruid: r } : r ? r : {}), this.readyState !== h.OPENED || C))
              ...
              (r.name = t.name || ""),
                t.isDetached()
                  ? (this.bind("RuntimeInit", function (e, t) {
                    ...
                    this.connectRuntime(e.extend({ required_caps: { access_image_binary: !0, resize_image: !0 } }, i)))
              ...
              e.extend(this, {
                      ...
                      switch (
                        ...
                        t.fit
                          ? ((a.width = Math.min(Math.ceil(s.width / r), o.width)),
                            ...
                            (r = s.width / a.width))
                          : ((a.width = Math.min(s.width, o.width)), (a.height = Math.min(s.height, o.height)), (r = 1)),
                ...
                downsize: function (t) {
                  ...
                  (i =
                    "object" == typeof t
                      ? e.extend(n, t)
                      : e.extend(n, { width: arguments[0], height: arguments[1], crop: arguments[2], preserveHeaders: arguments[3] })),
                    this.resize(i);
                },
                crop: function (e, t, i) {
                ...
                embed: function (n, r) {
                  function o(t, r) {
                    ...
                    if (u.can("use_data_uri_of", d.length))
                      (n.innerHTML = '<img src="' + d + '" width="' + o.width + '" height="' + o.height + '" alt="" />'), o.destroy(), c.trigger("embedded");
                    else {
                      var h = new s();
                  ...
                  try {
                    ...
                    return (
                      ...
                      this.meta.thumb && this.meta.thumb.width >= l.width && this.meta.thumb.height >= l.height
      ...
      n(
        ...
        ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/runtime/Runtime", "moxie/core/utils/Env"],
        function (e, t, i, n) {
          function o(t) {
            var o = this,
              u = i.capTest,
              ...
              l = e.extend(
                {
                  ...
                  select_folder: function () {
                    return (
                      o.can("select_file") &&
                      (("Chrome" === n.browser && n.verComp(n.version, 21, ">=")) || ("Firefox" === n.browser && n.verComp(n.version, 42, ">=")))
                    );
                  },
                  select_multiple: function () {
                    return !(
                      ...
                      ("iOS" === n.os && n.verComp(n.osVersion, "7.0.0", ">") && n.verComp(n.osVersion, "8.0.0", "<"))
                    );
                  },
            ...
            if (((i = i.toLowerCase()), t[r] && n[t[r]] && n[t[r]][i])) {
              ...
              for (
                ...
                ((a[u].orig !== o && a[u].key !== o) ||
                  (t.removeEventListener ? t.removeEventListener(i, a[u].func, !1) : t.detachEvent && t.detachEvent("on" + i, a[u].func),
                  (a[u].orig = null),
                  (a[u].func = null),
                  a.splice(u, 1),
                  o === s));
              ...
              init: function (u) {
                ...
                (e = u),
                  ...
                  (l.innerHTML =
                    ...
                    " />"),
                  (c = n.get(g.uid)),
                  i.extend(c.style, { position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }),
            ...
            function l(e) {
              ...
              return (
                "IE" === u.browser &&
                  ...
                  ((t = new window.ActiveXObject("Microsoft.XMLDOM")), (t.async = !1), (t.validateOnParse = !1), t.loadXML(i)),
                  ...
                  r +=
                    e instanceof o
                      ? i +
                        ...
                        e.getSource() +
                        n
                      : i + t + n + 'Content-Disposition: form-data; name="' + a + '"' + n + n + unescape(encodeURIComponent(e)) + n;
                }),
                (r += i + t + i + n)
              );
            }
            ...
            t.extend(this, {
              send: function (i, r) {
                ...
                m.upload
                  ...
                  "" !== i.responseType &&
                    "responseType" in m &&
                    (m.responseType = "json" !== i.responseType || u.can("return_response_type", "json") ? i.responseType : "text"),
                  p
                    ? m.sendAsBinary
                      ? m.sendAsBinary(r)
                      : (function () {
        ...
        return function i(n) {
          ...
          for (o = 2; o <= r.length(); )
            if (((a = r.SHORT(o)), a >= 65488 && 65495 >= a)) o += 2;
              ...
              (u = r.SHORT(o + 2) + 2),
                a >= 65505 && 65519 >= a && s.push({ hex: a, name: "APP" + (15 & a), start: o, length: u, segment: r.SEGMENT(o, u) }),
                (o += u);
            }
          return (
            r.clear(),
            {
              ...
              set: function (e, t) {
                ...
                for (
                  ...
                  r > i && (s[i].name === e.toUpperCase() && ((s[i].segment = o[n]), (s[i].length = o[n].length), n++), !(n >= o.length));
                  i++
                );
              },
              purge: function () {
        ...
        function (e, i, n) {
          function r(o) {
            function a(i, r) {
              ...
              for (o = p.SHORT(i), a = 0; o > a; a++)
                if (((g = []), (h = i + 2 + 12 * a), (s = r[p.SHORT(h)]), s !== t)) {
                  ...
                  "ASCII" !== u
                    ? ((g = p.asArray(u, h, c)), (f = 1 == c ? g[0] : g), (x[s] = l.hasOwnProperty(s) && "object" != typeof f ? l[s][f] : f))
            ...
            (d.IFD0 = d.tiffHeader + this.LONG((m += 2))),
              ...
              "ExifIFDPointer" in h && ((d.exifIFD = d.tiffHeader + h.ExifIFDPointer), delete h.ExifIFDPointer),
              "GPSInfoIFDPointer" in h && ((d.gpsIFD = d.tiffHeader + h.GPSInfoIFDPointer), delete h.GPSInfoIFDPointer),
      ...
      n(
        ...
        ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/runtime/html5/image/JPEG", "moxie/runtime/html5/image/PNG"],
        function (e, t, i, n) {
          return function (r) {
            var o,
              a = [i, n];
          ...
          function c() {
            ...
            function c() {
              ...
              return "canvas" == t.nodeName.toLowerCase()
                ? t
                : ((v = document.createElement("canvas")), (v.width = t.width), (v.height = t.height), v.getContext("2d").drawImage(t, 0, 0), v);
            }
            function l(e) {
            ...
            t.extend(this, {
                ...
                return (
                  ...
                  _ &&
                    ...
                    !t.meta ||
                      ...
                      (t.meta.thumb.data = new r(null, { type: "image/jpeg", data: t.meta.thumb.data }))),
                  t
                );
              },
              ...
              getAsBlob: function (e, t) {
                return e !== this.type
                  ? ((b = !0), new o(null, { name: y.name || "", type: e, data: E.getAsDataURL(e, t) }))
              ...
              getAsBinaryString: function (e, t) {
                ...
                if ("image/jpeg" !== e) w = l(E.getAsDataURL(e, t));
                  ...
                  (w = l(i)),
                    x &&
                      ((w = x.stripHeaders(w)),
                      _ && (x.meta && x.meta.exif && x.setExif({ PixelXDimension: this.width, PixelYDimension: this.height }), (w = x.writeHeaders(w))),
                      x.purge(),
                      (x = null));
                }
                return (b = !1), w;
      ...
      n(
        ...
        ["moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/runtime/Runtime"],
        function (e, t, i, n, o) {
          function a() {
            var e;
            try {
                ...
                this,
                {
                  ...
                  init: function () {
                    ...
                    (a = this.getShimContainer()),
                      e.extend(a.style, { position: "absolute", top: "-8px", left: "-8px", width: "9px", height: "9px", overflow: "hidden" }),
      ...
      n(
        ...
        ["moxie/runtime/flash/Runtime", "moxie/file/File", "moxie/core/utils/Dom", "moxie/core/utils/Basic"],
        function (e, t, i, n) {
          var r = {
            init: function (e) {
              var r = this,
              ...
              a && (a.setAttribute("tabindex", -1), (a = null)),
                ...
                this.getRuntime().shimExec.call(this, "FileInput", "init", { accept: e.accept, multiple: e.multiple }),
                this.trigger("ready");
            },
          };
        ...
        var n = {
          read: function (e, t) {
            ...
            return (n = r.shimExec.call(this, "FileReaderSync", "readAsBase64", t.uid))
              ? ("readAsDataURL" === e && (n = "data:" + (t.type || "") + ";base64," + n), i(n, e, t.type))
              : null;
          },
        };
      ...
      n(
        ...
        ["moxie/runtime/flash/Runtime", "moxie/core/utils/Basic", "moxie/runtime/Transporter", "moxie/file/Blob", "moxie/file/FileReaderSync"],
        function (e, t, i, n, r) {
          var o = {
            loadFromBlob: function (e) {
              function t(e) {
            ...
            getInfo: function () {
              ...
              return (
                t.meta && t.meta.thumb && t.meta.thumb.data && !(e.meta.thumb.data instanceof n) && (t.meta.thumb.data = new n(e.uid, t.meta.thumb.data)), t
              );
            },
            getAsBlob: function (e, t) {
              var i = this.getRuntime(),
      ...
      n(
        ...
        ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/runtime/flash/file/Blob"],
        function (e, t, i) {
      ...
      n(
        ...
        ["moxie/runtime/silverlight/Runtime", "moxie/file/File", "moxie/core/utils/Dom", "moxie/core/utils/Basic"],
        function (e, t, i, n) {
          function r(e) {
      ...
      n(
        ...
        ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/runtime/flash/file/FileReader"],
        function (e, t, i) {
      ...
      n(
        ...
        ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/runtime/flash/file/FileReaderSync"],
        function (e, t, i) {
      ...
      n(
        ...
        ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/file/Blob", "moxie/runtime/flash/image/Image"],
        function (e, t, i, n) {
          ...
          function s() {
            function e() {
              ...
              (f = i.guid("uid_")),
                ...
                s && ((d = n.get(s + "_form")), d && (i.extend(d.style, { top: "100%" }), d.firstChild.setAttribute("tabindex", -1))),
                ...
                i.extend(m.style, { overflow: "hidden", position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }),
                ...
                m.appendChild(h),
                o.appendChild(m),
                i.extend(h.style, { position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }),
                "IE" === a.browser && a.verComp(a.version, 10, "<") && i.extend(h.style, { filter: "progid:DXImageTransform.Microsoft.Alpha(opacity=0)" }),
                (h.onchange = function () {
                  var i;
                  this.value &&
                  ...
                  (function () {
                    ...
                    (e = n.get(t.browse_button)),
                      ...
                      s.can("summon_file_dialog")
                        ? ("static" === n.getStyle(e, "position") && (e.style.position = "relative"),
  ...
  !(function (e, i) {
    ...
    r("plupload", [], function () {
              ...
              setOption: function (t, i, n) {
                ...
                return "object" == typeof t
                  ...
                  : ((!n || s._options.hasOwnProperty(t)) &&
                      ...
                      "object" === e.typeOf(i) && "object" === e.typeOf(s._options[t]) ? e.extend(s._options[t], i) : (s._options[t] = i),
            ...
            t.extend(i.prototype, {
              ...
              resume: function () {
                ...
                return this.state !== i.PAUSED && this.state !== i.RESUMED
                  ? !1
                  : ((this.state = i.RESUMED), this.trigger("statechanged", this.state, t), this.trigger("resumed"), !0);
              },
              stop: function () {
                var t = this.state;
              ...
              destroy: function () {
                ...
                return this.state === i.DESTROYED
                  ? !1
                  : ((this.state = i.DESTROYED), this.trigger("statechanged", this.state, t), this.trigger("destroy"), this.unbindAll(), !0);
              },
            }),
            i
          );
        ...
        return (function (r) {
          function s(i) {
            r.apply(this, arguments),
              (this._queue = new e()),
              (this.stats = new n()),
              (this._options = t.extend({}, this._options, { max_slots: 1, max_retries: 0, auto_start: !1, finish_active: !1 }, i));
          }
          function o() {
            var t;
            return (
            ...
            t.extend(s.prototype, {
              ...
              addItem: function (e) {
                ...
                e.bind("Started", function () {
                  ...
                  this.calcStats(),
                  e.trigger("Queued"),
                  (n.getOption("auto_start") || n.state === i.PAUSED) && t.delay.call(this, this.start);
              },
                ...
                return e
                  ? (e.reset(),
                    t.forEachItem(function (s) {
                      ...
                      (n += s.processed),
                        (!s.processedTimestamp || s.processedTimestamp > t.startedTimestamp) && (r += n),
                        (e.processedPerSec = Math.ceil(r / ((+new Date() - t.startedTimestamp || 1) / 1e3))),
                        (e.processed = n),
                        (e.total += s.total),
      ...
      r("plupload/QueueResize", ["plupload", "plupload/core/Queue"], function (t, e) {
        return (function (i) {
          function n(t) {
            e.call(this, { max_slots: 1, max_retries: 0, auto_start: !1, finish_active: !1, resize: {} }),
              (this.setOption = function (t, e) {
      ...
      r("plupload/ChunkUploader", ["plupload", "plupload/core/Collection", "plupload/core/Queueable"], function (e, i, n) {
        function r(t) {
          ...
          var a;
          n.call(this),
            (this._options = { file_data_name: "file", headers: !1, http_method: "POST", multipart: !0, params: {}, send_file_name: !0, url: !1 }),
            e.extend(this, {
              start: function () {
                var r,
                  u,
                ...
                this.startedTimestamp || (this.startedTimestamp = +new Date()),
                  ...
                  (a.onload = function () {
                    var t = { response: this.responseText, status: this.status, responseHeaders: this.getAllResponseHeaders() };
                  ...
                  (r = c.multipart ? c.url : i(c.url, c.params)),
                    ...
                    c.multipart
                      ? ((u = new o()),
                        ...
                        a.send(u))
                      : ((e.isEmptyObj(c.headers) || !a.hasRequestHeader("content-type")) && a.setRequestHeader("content-type", "application/octet-stream"),
                        a.send(t)),
                    this.trigger("started");
                } catch (d) {
                  l.failed();
              ...
              start: function () {
                ...
                return this.state === i.PROCESSING
                  ...
                  : (this.startedTimestamp || (this.startedTimestamp = +new Date()),
                    ...
                    e._options.send_file_name && (e._options.params.name = e.target_name || e.name),
              ...
              uploadChunk: function (e, r) {
                ...
                return (
                  ...
                  g.start < 0 || g.start >= s.size
                    ? !1
                    : ((d = t.extendImmutable({}, this.getOptions(), { params: { chunk: g.seq, chunks: p } })),
      ...
      r("plupload/ImageResizer", ["plupload", "plupload/core/Queueable"], function (e, i) {
        function n(t) {
          i.call(this),
            (this._options = { type: "image/jpeg", quality: 90, crop: !1, fit: !0, preserveHeaders: !0, resample: "default", multipass: !0 }),
              ...
              start: function () {
                ...
                return this.state === e.PROCESSING
                  ...
                  : ((this.state = e.PROCESSING),
                    ...
                    this.trigger("started"),
                    !t.isEmptyObj(this._options.resize) && s(this.type) && o(a, "send_binary_string") ? this.resizeAndUpload() : this.upload(),
                    !0);
              },
              getSource: function () {
                return a;
      ...
      r(
        "plupload/Uploader",
        ["plupload", "plupload/core/Collection", "plupload/core/Queue", "plupload/QueueUpload", "plupload/QueueResize", "plupload/File"],
                  ...
                  e.each(n.getOption("browse_button"), function (i) {
                    s.push(function (s) {
                      ...
                      (a.onready = function () {
                        ...
                        e.extend(n.features, { chunks: t.can("slice_blob"), multipart: t.can("send_multipart"), multi_selection: t.can("select_multiple") }),
                          r++,
                          O.push(this),
                          s();
                      }),
                          ...
                          R ||
                            (n.getOption("browse_button_hover") &&
                              ("mouseenter" === t.type
                                ...
                                : "mouseleave" === t.type && e.removeClass(i, n.getOption("browse_button_hover"))),
                            n.getOption("browse_button_active") &&
                              ("mousedown" === t.type
                                ? e.addClass(i, n.getOption("browse_button_active"))
                                : "mouseup" === t.type && e.removeClass(i, n.getOption("browse_button_active"))));
                        }),
                ...
                n.getOption("drop_element") &&
                  e.each(n.getOption("drop_element"), function (i) {
                    s.push(function (s) {
                      ...
                      (a.onready = function () {
                        var t = e.Runtime.getInfo(this.ruid);
                        e.extend(n.features, { chunks: t.can("slice_blob"), multipart: t.can("send_multipart"), dragdrop: t.can("drag_and_drop") }),
                          r++,
                          b.push(this),
                          s();
                      }),
                  ...
                  return (
                    ...
                    e.each(["container", "browse_button", "drop_element"], function (t) {
                      return null === n.getOption(t)
                        ? ((i = { code: e.INIT_ERROR, message: e.sprintf(e.translate("%s specified, but cannot be found."), t) }), !1)
                        : void 0;
                    }),
                    i
                      ? n.trigger("Error", i)
                          ...
                          "function" == typeof o
                            ...
                            t
                              ? ((E = !0),
                                ...
                                n.trigger("PostInit"))
                              : n.trigger("Error", { code: e.INIT_ERROR, message: e.translate("Init error.") });
                        }),
                        void 0)
                      : n.trigger("Error", { code: e.INIT_ERROR, message: e.translate("You must specify either browse_button or drop_element.") })
                  );
                },
                setOption: function (t, i) {
                  return E &&
                    e.inArray(t, ["container", "browse_button", "drop_element", "runtimes", "multi_selection", "flash_swf_url", "silverlight_xap_url"]) > -1
                    ? this.trigger("Error", { code: e.OPTION_ERROR, message: e.sprintf(e.translate("%s option cannot be changed.")), option: t })
                    : ("object" != typeof t && ((i = p(t, i, this._options)), y && y.setOption(t, i), v && v.setOption(t, i)),
                ...
                dispatchEvent: function (t) {
                  ...
                  if (((t = t.toLowerCase()), (e = this.hasEventListener(t)))) {
                    e.sort(function (t, e) {
                      ...
                      i.shift(),
                      i.unshift(this);
                    for (var n = 0; n < e.length; n++) if (e[n].fn.apply(e[n].scope, i) === !1) return !1;
                  }
                  return !0;
                },
            ...
            switch (t) {
              ...
              case "filters":
                return (
                  ...
                  i.mime_types &&
                    ("string" === e.typeOf(i.mime_types) && (i.mime_types = e.mimes2extList(i.mime_types)),
                      ...
                      return (
                        e.each(t, function (t) {
                          e.each(t.extensions.split(/,/), function (t) {
                            /^\s*\*\s*$/.test(t)
                              ? i.push("\\.*")
                              : i.push("\\." + t.replace(new RegExp("[" + "/^$.*+?|()[]{}\\".replace(/./g, "\\$&") + "]", "g"), "\\$&"));
                          });
                        }),
                        new RegExp("(" + i.join("|") + ")$", "i")
                      );
          ...
          return (
            c("mime_types", function (t, i, n) {
              t.length && !this.getOption("re_ext_filter").test(i.name)
                ? (this.trigger("Error", { code: e.FILE_EXTENSION_ERROR, message: e.translate("File extension error."), file: i }), n(!1))
                : n(!0);
            }),
            c("max_file_size", function (t, i, n) {
              ...
              (t = e.parseSize(t)),
                i.size !== r && t && i.size > t
                  ? (this.trigger("Error", { code: e.FILE_SIZE_ERROR, message: e.translate("File size error."), file: i }), n(!1))
                  : n(!0);
            }),
              ...
              t &&
                this.forEachItem(function (t) {
                  return i.name === t.name && i.size === t.size
                    ? (r.trigger("Error", { code: e.FILE_DUPLICATE_ERROR, message: e.translate("Duplicate file error."), file: i }), n(!1), void 0)
                    : void 0;
                }),
                n(!0);
            }),
