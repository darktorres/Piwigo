...
<fieldset>
  ...
  <p>
    <label>
      ...
      <br>
      <input type="text" id="username_or_email" name="username_or_email" size="100" maxlength="100"{if isset($username_or_email)} value="{$username_or_email}"{/if} autocomplete="email">
    </label>
  </p>
