...
{combine_script id='equalheights' require='jquery' path='https://raw.githack.com/Piwigo/piwigo-bootstrap-darkroom/refs/heads/master/js/jquery.equalheights.js' load='footer'}
