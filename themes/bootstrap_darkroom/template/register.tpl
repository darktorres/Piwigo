            ...
            <div class="panel-body">
              <fieldset>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="login" id="login" value="{$F_LOGIN}" class="form-control" placeholder="{'Username'|@translate}" required="required" autocomplete="username"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="password" class="col-sm-2 control-label">{'Password'|@translate} *</label>
                    <div class="col-sm-4">
                        <input type="password" name="password" id="password" class="form-control" placeholder="{'Password'|@translate}" required="required" autocomplete="new-password"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="password_conf" class="col-sm-2 control-label">{'Confirm Password'|@translate} *</label>
                    <div class="col-sm-4">
                        <input type="password" name="password_conf" id="password_conf" class="form-control" placeholder="{'Confirm Password'|@translate}" required="required" autocomplete="new-password"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="mail_address" class="col-sm-2 control-label">{'Email address'|@translate}{if $obligatory_user_mail_address} *{/if}</label>
                    <div class="col-sm-4">
                        <input type="email" name="mail_address" id="mail_address" value="{$F_EMAIL}" class="form-control" placeholder="{'Email address'|@translate}"{if $obligatory_user_mail_address} required="required"{/if} autocomplete="email">
