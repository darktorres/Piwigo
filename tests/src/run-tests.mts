...
async function runPuppeteerScript(counter: number, commitMessage: string): Promise<void> {
...
async function savePageContent(page: Page, url: string, counter: number, commitMessage: string): Promise<void> {
...
async function getCommitHashes(firstCommit: string, lastCommit: string): Promise<string[]> {
...
async function getCommitMessage(commitHash: string): Promise<string> {
