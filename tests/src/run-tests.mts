...
async function runPuppeteerScript(): Promise<void> {
  ...
  // Database config
  // await page.type("#content > form > fieldset:nth-child(2) > table > tbody > tr:nth-child(2) > td:nth-child(2) > input[type=text]", "root"); // dbuser
  // await page.type("#content > form > fieldset:nth-child(2) > table > tbody > tr:nth-child(3) > td:nth-child(2) > input[type=password]", "1234"); //dbpassword
  // await page.type("#content > form > fieldset:nth-child(2) > table > tbody > tr:nth-child(4) > td:nth-child(2) > input[type=text]", "piwigo2"); // dbname

  // await page.focus("#content > form > fieldset:nth-child(2) > table > tbody > tr:nth-child(5) > td:nth-child(2) > input[type=text]"); // dbprefix
  ...
  // await page.click("#content > form > fieldset:nth-child(3) > table > tbody > tr:nth-child(5) > td:nth-child(2) > label:nth-child(1) > input[type=checkbox]"); // subscribe email
  // await page.click("#content > form > fieldset:nth-child(3) > table > tbody > tr:nth-child(5) > td:nth-child(2) > label:nth-child(3) > input[type=checkbox]"); // send email with settings

  await page.click("#content > form > div > input"); // install button

  // Admin pages
  await page.waitForSelector("#content > p > a"); // go to homepage
  await page.click("#content > p > a");
  await page.waitForSelector("#deactivate > a"); // deactivate empty gallery message
  await page.click("#deactivate > a");
  await page.waitForSelector("#menubar > dl:nth-child(7) > dt > a:nth-child(4)"); // admin button
  await page.click("#menubar > dl:nth-child(7) > dt > a:nth-child(4)");
  await page.waitForSelector("#content > p > span > a.newsletter-hide"); // hide subscribe to newsletter button
  await page.click("#content > p > span > a.newsletter-hide");
  await page.waitForSelector("#content > p > a"); // do a quick sync
  await page.click("#content > p > a");
  ...
  // Gallery
  await page.waitForSelector("#pwgHead > a"); // go to homepage
  await page.click("#pwgHead > a");
  await sleep(1500);
  await page.waitForSelector("#rv-at > li > a > img"); // open album
  await page.click("#rv-at > li > a > img");
  await sleep(1500);
  await page.waitForSelector("#thumbnails > li:nth-child(1) > a > img"); // open image
  await page.click("#thumbnails > li:nth-child(1) > a > img");
  await sleep(1500);
...
async function clearDirectoryExcept(dir: string, exclude?: string): Promise<void> {
