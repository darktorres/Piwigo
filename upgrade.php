...
\Piwigo\inc\functions::load_language('common.lang', '', [
    'language' => $language,
    'target_charset' => 'utf-8',
    'no_fallback' => true,
]);
\Piwigo\inc\functions::load_language('admin.lang', '', [
    'language' => $language,
    'target_charset' => 'utf-8',
    'no_fallback' => true,
]);
\Piwigo\inc\functions::load_language('install.lang', '', [
    'language' => $language,
    'target_charset' => 'utf-8',
    'no_fallback' => true,
]);
\Piwigo\inc\functions::load_language('upgrade.lang', '', [
    'language' => $language,
    'target_charset' => 'utf-8',
    'no_fallback' => true,
]);
...
;';
                ...
                // we need the secret key for \Piwigo\inc\functions::get_pwg_token()
