...
function ws_getCacheSize(
    ...
    if (function_exists('exec')) {
        ...
        if (
            is_array($return_array_cache) && ! empty($return_array_cache[0]) && preg_match('/^(\d+)\s/', $return_array_cache[0], $matches_cache)
        ) {
    ...
    if (function_exists('exec')) {
        ...
        if (
            is_array($return_array_template_c) && ! empty($return_array_template_c[0]) && preg_match('/^(\d+)\s/', $return_array_template_c[0], $matches_template_c)
        ) {
