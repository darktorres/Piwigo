...
class Smarty_Internal_Configfileparser
{
     ...
     * @return string
     */
    private static function parse_single_quoted_string(
        $qstr
    ) {
     ...
     * @return string
     */
    private static function parse_double_quoted_string(
        $qstr
    ) {
     ...
     * @return string
     */
    private static function parse_tripple_double_quoted_string(
        $qstr
    ) {
     ...
     */
    private function add_section_vars(
        $section_name,
        array $vars
    ) {
