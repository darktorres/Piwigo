...
class Smarty_Internal_Compile_Functionclose extends Smarty_Internal_CompileBase
{
    ...
    public function compile(
        ...
        $compiler->parser->current_buffer = new Smarty_Internal_ParseTree_Template();
        $_funcName = sprintf('smarty_template_function_%s_%s', $_name, $compiler->template->compiled->nocache_hash);
        $_funcNameCaching = $_funcName . '_nocache';
        if ($compiler->template->compiled->has_nocache_code) {
            $compiler->parent_compiler->tpl_function[$_name]['call_name_caching'] = $_funcNameCaching;
            $output = "<?php\n";
            $output .= $compiler->cStyleComment(sprintf(' %s ', $_funcNameCaching)) . "\n";
            ...
            $output .= sprintf('/*/%%%%SmartyNocache:%s%%%%*/";?>', $compiler->template->compiled->nocache_hash);
            ...
            $output .= "}\n}\n";
            $output .= $compiler->cStyleComment(sprintf('/ %s_nocache ', $_funcName)) . "\n\n";
            $output .= "?>\n";
            $compiler->parser->current_buffer->append_subtree(
                $compiler->parser,
                new Smarty_Internal_ParseTree_Tag(
        ...
        $output = "<?php\n";
        $output .= $compiler->cStyleComment(sprintf(' %s ', $_funcName)) . "\n";
