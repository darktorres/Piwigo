...
function smarty_function_html_select_time(
        ...
        switch ($_key) {
            ...
            default:
                if (! is_array($_value)) {
                    ...
                    trigger_error(
                        sprintf("html_select_date: extra attribute '%s' cannot be an array", $_key),
                        E_USER_NOTICE
                    );
                }
    ...
    if (isset($params['time']) && is_array($params['time'])) {
        if (isset($params['time'][$prefix . 'Hour'])) {
            ...
            [$_hour, $_minute, $_second] = explode('-', date('H-i-s', $time));
        ...
        if (array_key_exists('time', $params)) {
            ...
            [$_hour, $_minute, $_second] = explode('-', date('H-i-s'));
            $time = [$_hour, $_minute, $_second];
        }
    } else {
        [$_hour, $_minute, $_second] = explode('-', date('H-i-s', $time));
