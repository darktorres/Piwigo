...
if (isset($_GET['delete'])) {
    ...
    \Piwigo\admin\inc\functions::delete_elements([$_GET['image_id']], true);
...
if (isset($_GET['sync_metadata'])) {
    functions_metadata::sync_metadata([intval($_GET['image_id'])]);
...
if (isset($_POST['submit'])) {
    ...
    \Piwigo\admin\inc\functions::move_images_to_categories([$_GET['image_id']], $_POST['associate']);
...
$template->assign([
    ...
    'CACHE_KEYS' => \Piwigo\admin\inc\functions::get_admin_client_cache_keys(['tags', 'categories']),
