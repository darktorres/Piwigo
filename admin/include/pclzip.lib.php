...
class PclZip
{
    ...
    public function create(
        ...
        if (is_array($p_filelist)) {
            ...
            if (isset($p_filelist[0]) && is_array(
                $p_filelist[0]
            )) {
        ...
        if ($v_size > 0) {
            ...
            if ((is_int($v_arg_list[0])) && ($v_arg_list[0] > 77000)) {
                ...
                if (isset($v_options[PCLZIP_OPT_ADD_PATH])) {
                    ...
                    if ((strlen((string) $v_path) > 0) && (! str_ends_with(
                        (string) $v_path,
                        '/'
                    ))) {
                        $v_path .= '/';
    ...
    // --------------------------------------------------------------------------------
    public function privCheckFormat(
        $p_level = 0
    ) {
        $v_result = true;
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privOptionDefaultThreshold(
        &$p_options
    ) {
        $v_result = 1;
    ...
    //   0 on failure.
    // --------------------------------------------------------------------------------
    public function privFileDescrExpand(
        &$p_filedescr_list,
        &$p_options
    ) {
        $v_result = 1;
    ...
    public function privAdd(
        ...
        if ((! is_file($this->zipname)) || (filesize(
            $this->zipname
        ) == 0)) {
    ...
    public function privAddFileUsingTempFile(
        ...
        $v_gzip_temp_name = PCLZIP_TEMPORARY_DIR . uniqid(
            'pclzip-'
        ) . '.gz';
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privCalculateStoredFilename(
        &$p_filedescr,
        &$p_options
    ) {
        $v_result = 1;
        ...
        // ----- Look for path and/or short name change
            ...
            elseif ($p_remove_dir != '') {
                ...
                if ($v_compare > 0) {
                    $v_stored_filename = $v_compare == 2 ? '' : substr(
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privWriteFileHeader(
        &$p_header
    ) {
        $v_result = 1;
        ...
        if (strlen((string) $p_header['stored_filename']) != 0) {
            fwrite(
                $this->zip_fd,
                (string) $p_header['stored_filename'],
                strlen((string) $p_header['stored_filename'])
            );
        }
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privWriteCentralFileHeader(
        &$p_header
    ) {
        $v_result = 1;
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privConvertHeader2FileInfo(
        $p_header,
        &$p_info
    ) {
        $v_result = 1;
    ...
    public function privExtractByRule(
        ...
        if (($p_remove_path != '') && (! str_ends_with(
            ...
            if ((isset($p_options[PCLZIP_OPT_BY_NAME]))
                ...
                for ($j = 0; ($j < count(
                    ...
                    if (str_ends_with((string) $p_options[PCLZIP_OPT_BY_NAME][$j], '/')) {
                        ...
                        if ((strlen(
                            (string) $v_header['stored_filename']
                        ) > strlen(
                            (string) $p_options[PCLZIP_OPT_BY_NAME][$j]
                        ))
                              && (str_starts_with(
                                  (string) $v_header['stored_filename'],
                                  (string) $p_options[PCLZIP_OPT_BY_NAME][$j]
    ...
    public function privExtractFile(
        ...
        if ($p_entry['status'] == 'ok') {
            ...
            // ----- Check the directory availability and create it if necessary
                ...
                if ((($p_entry['external'] & 0x00000010) == 0x00000010) || (str_ends_with(
                    (string) $p_entry['filename'],
                    '/'
                ))) {
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privExtractFileUsingTempFile(
        &$p_entry,
        &$p_options
    ) {
        $v_result = 1;
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privExtractFileInOutput(
        &$p_entry,
        &$p_options
    ) {
        $v_result = 1;
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privExtractFileAsString(
        &$p_entry,
        &$p_string,
        &$p_options
    ) {
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privReadFileHeader(
        &$p_header
    ) {
        $v_result = 1;
        ...
        // ----- Get extra_fields
        $p_header['extra'] = $v_data['extra_len'] != 0 ? fread(
            $this->zip_fd,
            $v_data['extra_len']
        ) : '';
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privReadCentralFileHeader(
        &$p_header
    ) {
        $v_result = 1;
        ...
        // ----- Get filename
        $p_header['filename'] = $p_header['filename_len'] != 0 ? fread(
            $this->zip_fd,
            $p_header['filename_len']
        ) : '';

        // ----- Get extra
        $p_header['extra'] = $p_header['extra_len'] != 0 ? fread(
            $this->zip_fd,
            $p_header['extra_len']
        ) : '';

        // ----- Get comment
        $p_header['comment'] = $p_header['comment_len'] != 0 ? fread(
            $this->zip_fd,
            $p_header['comment_len']
        ) : '';
    ...
    //   0 on error;
    // --------------------------------------------------------------------------------
    public function privCheckFileHeaders(
        &$p_local_header,
        &$p_central_header
    ) {
        $v_result = 1;
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privReadEndCentralDir(
        &$p_central_dir
    ) {
        $v_result = 1;
        ...
        // ----- Get comment
        $p_central_dir['comment'] = $v_data['comment_size'] != 0 ? fread(
            $this->zip_fd,
            $v_data['comment_size']
        ) : '';
    ...
    // Return Values :
    // --------------------------------------------------------------------------------
    public function privDeleteByRule(
        &$p_result_list,
        &$p_options
    ) {
        $v_result = 1;
    ...
    public function privDirCheck(
        ...
        if ($p_parent_dir != $p_dir && $p_parent_dir !== '' && ($v_result = $this->privDirCheck(
            $p_parent_dir
        )) != 1) {
            return $v_result;
        }
