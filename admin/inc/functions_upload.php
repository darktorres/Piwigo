...
class functions_upload
{
  ...
  ;';
            ...
            functions::delete_element_files([$image_id]);
        } else {
            // this photo is new
        ...
        functions_metadata::sync_metadata([$image_id]);
  ...
  ;';
    ...
    public static function add_uploaded_file_add_to_categories($image_id, $categories)
    {
        ...
        if (isset($categories) and count($categories) > 0) {
            if ($conf['lounge_active']) {
                functions::fill_lounge([$image_id], $categories);
            } else {
                functions::associate_images_to_categories([$image_id], $categories);
            }
        }
    ...
    public static function add_format($source_filepath, $format_ext, $format_of)
    {
        ...
        if (! in_array($format_ext, \Piwigo\inc\functions::conf_get_param('format_ext', ['cr2']))) {
            die('[' . __FUNCTION__ . '] unexpected format extension "' . $format_ext . '" (authorized extensions: ' . implode(', ', \Piwigo\inc\functions::conf_get_param('format_ext', ['cr2'])) . ')');
        }
  ...
  ;';
        ...
        \Piwigo\inc\functions::pwg_activity('photo', $format_of, 'edit', [
            'action' => 'add format',
    ...
    public static function upload_file_pdf($representative_ext, $file_path)
    {
        ...
        if (! in_array(strtolower(\Piwigo\inc\functions::get_extension($file_path)), ['pdf'])) {
            return $representative_ext;
        }
    ...
    public static function upload_file_heic($representative_ext, $file_path)
    {
        ...
        if (! in_array(strtolower(\Piwigo\inc\functions::get_extension($file_path)), ['heic'])) {
            return $representative_ext;
        }
    ...
    public static function upload_file_tiff($representative_ext, $file_path)
    {
        ...
        if (! in_array(strtolower(\Piwigo\inc\functions::get_extension($file_path)), ['tif', 'tiff'])) {
            return $representative_ext;
        }
    ...
    public static function upload_file_psd($representative_ext, $file_path)
    {
        ...
        if (! in_array(strtolower(\Piwigo\inc\functions::get_extension($file_path)), ['psd'])) {
            return $representative_ext;
        }
    ...
    public static function upload_file_eps($representative_ext, $file_path)
    {
        ...
        if (! in_array(strtolower(\Piwigo\inc\functions::get_extension($file_path)), ['eps'])) {
            return $representative_ext;
        }
