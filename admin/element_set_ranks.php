...
if ($category['image_order'] == 'rank ASC' || $category['image_order'] == 'rank_column ASC') {
...
$query =
"SELECT id, file, path, representative_ext, width, height, rotation, name, rank_column FROM images JOIN image_category ON image_id = id
 WHERE category_id = {$page['category_id']} ORDER BY rank_column;";
