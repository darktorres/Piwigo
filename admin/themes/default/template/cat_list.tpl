      ...
      <div class="categoryBox{if $category.IS_VIRTUAL} virtual_cat{/if}" id="cat_{$category.ID}">
        ...
        <div class="albumActions">
          ...
          {if cat_admin_access($category.ID)}
            <a href="{$category.U_JUMPTO}" class="actionGalery" {*title="{'Visit Gallery'|@translate}"*}><span
                class="icon-eye tiptip" title="{'Visit Gallery'|@translate}"></span><span
                class="iconLegend">{'Visit Gallery'|@translate}</span></a>
          {else}
            <span href="{$category.U_JUMPTO}" class="actionGalery" {*title="{'This album is private'|@translate}"*}><span
