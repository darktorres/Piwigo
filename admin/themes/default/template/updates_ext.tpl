...
{combine_script id='jquery.jgrowl' load='footer' require='jquery' path='themes/default/js/plugins/jquery.jgrowl.min.js'}
{combine_css path="themes/default/js/plugins/jquery.jgrowl.min.css"}
