...
{combine_script id='jquery.tipTip' load='footer' path='https://raw.githack.com/drewwilson/TipTip/refs/heads/master/jquery.tipTip.minified.js'}
...
<div class="cat-modify" id="cat-modify">
  ...
  <div class="cat-modify-content">
    ...
    <div
      ...
      {if isset($representant) && isset($representant.picture)}style="background-image:url('{$representant.picture.src}')"
      {/if}>
      {if isset($representant) and ($representant.ALLOW_SET_RANDOM || $representant.ALLOW_SET_RANDOM)}
        <div class="cat-modify-representative-actions">
          ...
          {if isset($representant.ALLOW_DELETE)}
            <a class="deleteRepresentative buttonLike" id="deleteRepresentative" title="{'Delete Representant'|@translate}"
              style="{if !isset($representant.picture)}display:none{/if}">
  ...
  <div class="cat-modify-footer">
    <div class="cat-modify-footer-start">
      {if \Piwigo\admin\inc\functions::cat_admin_access($CAT_ID)}
