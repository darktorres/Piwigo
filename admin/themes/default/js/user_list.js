...
$( document ).ready(function() {
    ...
    $(".yes_no_radio .user-list-checkbox").off("click").on("click", function () {
...
function fill_user_edit_update(user_to_edit, pop_in) {
    pop_in.find('.update-user-button').off("click").on("click", 
    ...
    pop_in.find('.delete-user-button').off("click").on("click", function () {
        $.confirm({
