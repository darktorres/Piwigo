...
;';
    ...
    if ($action == 'associate') {
        ...
        functions::move_images_to_categories($collection, [$_POST['associate']]);
    ...
    elseif ($action == 'author') {
        ...
        \Piwigo\inc\functions::pwg_activity('photo', $collection, 'edit', [
            'action' => 'author',
        ]);
    }
...
$prefilters = [
    [
        'ID' => 'caddie',
        'NAME' => \Piwigo\inc\functions::l10n('Caddie'),
    ],
    [
        'ID' => 'favorites',
        'NAME' => \Piwigo\inc\functions::l10n('Your favorites'),
    ],
    [
        'ID' => 'last_import',
        'NAME' => \Piwigo\inc\functions::l10n('Last import'),
    ],
    [
        'ID' => 'no_album',
        'NAME' => \Piwigo\inc\functions::l10n('With no album') . ' (' . \Piwigo\inc\functions::l10n('Orphans') . ')',
    ],
    [
        'ID' => 'no_tag',
        'NAME' => \Piwigo\inc\functions::l10n('With no tag'),
    ],
    [
        'ID' => 'duplicates',
        'NAME' => \Piwigo\inc\functions::l10n('Duplicates'),
    ],
    [
        'ID' => 'all_photos',
        'NAME' => \Piwigo\inc\functions::l10n('All'),
    ],
];
...
if ($conf['enable_synchronization']) {
    $prefilters[] = [
        'ID' => 'no_virtual_album',
        'NAME' => \Piwigo\inc\functions::l10n('With no virtual album'),
    ];
    $prefilters[] = [
        'ID' => 'no_sync_md5sum',
        'NAME' => \Piwigo\inc\functions::l10n('With no checksum'),
    ];
}
...
$template->assign([
    ...
    'CACHE_KEYS' => functions::get_admin_client_cache_keys(['tags', 'categories']),
]);
